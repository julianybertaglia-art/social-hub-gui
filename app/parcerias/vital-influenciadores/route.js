...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:linear-gradient(145deg,#ede8dc 0,#f7f5ef 48%,#eee9df 100%);color:var(--ink);font-family:Arial,sans-serif;min-height:100vh;display:grid;place-items:center;padding:20px}
    ...
    .brand{display:inline-flex;align-items:center}.brand img{display:block;width:190px;max-width:55vw;height:auto;margin:0 auto}
...
<body><main class="card"><div class="brand"><img src="/vital-decor-logo.png" alt="Vital Decor"></div><h1>Este link não está válido.</h1><p>Para sua inscrição ficar vinculada corretamente ao WhatsApp, use o link individual enviado pela nossa equipe.</p><p class="hint">Volte para a conversa no WhatsApp e solicite um novo link.</p></main></body>
</html>`, {
    status: 404,
    headers: RESPONSE_HEADERS,
  });
