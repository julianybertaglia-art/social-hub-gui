...
const defaultIdeas = [
  {
    id: 210901,
    title: 'Se você vende muito e nunca tem dinheiro no caixa, provavelmente o problema está aqui.',
    audience: 'Sellers com faturamento, mas margem/caixa apertados. Ângulo: 3 vazamentos — margem, estoque e Ads.',
    format: 'Reel',
    priority: 'Alta',
  },
  {
    id: 210902,
    title: 'O Mercado Livre cresce muito. Então por que tanto seller continua sem margem?',
    audience: 'Sellers em escala. Ângulo: crescimento do marketplace x eficiência da operação. CTA: salvar antes de escalar.',
    format: 'Reel',
    priority: 'Alta',
  },
  {
    id: 210903,
    title: 'Amanhã começa o Mercado Livre Experience. Essas são as 3 coisas que eu quero descobrir lá.',
    audience: 'Sellers e participantes do ML Experience. Ângulo: antecipação + opinião do Gui sobre o que realmente importa.',
    format: 'Reel',
    priority: 'Alta',
  },
  {
    id: 210904,
    title: 'Estou no Mercado Livre Experience e essa foi a coisa mais importante que ouvi hoje para quem vende.',
    audience: 'Sellers acompanhando as novidades do evento. Ângulo: escolher UMA ideia e interpretar o impacto prático.',
    format: 'Reel',
    priority: 'Alta',
  },
  {
    id: 210905,
    title: 'Depois de dois dias de ML Experience, essas são as 3 mudanças que realmente importam para o seller.',
    audience: 'Sellers que querem filtrar novidades e aplicar na operação. Ângulo: resumo com opinião prática, sem recap genérico.',
    format: 'Reel',
    priority: 'Alta',
  },
  {
    id: 210906,
    title: '40 sellers numa sala. Esse é o problema que mais apareceu quando começamos a abrir as operações.',
    audience: 'Sellers intermediários e avançados. Ângulo: transformar a Imersão em prova de autoridade e diagnóstico real.',
    format: 'Reel',
    priority: 'Alta',
  },
  {
    id: 210907,
    title: '7 decisões que um seller precisa tomar antes do último trimestre.',
    audience: 'Sellers preparando Q4. Ângulo: margem, estoque, Ads, reputação, produto, fiscal e operação.',
    format: 'Carrossel',
    priority: 'Alta',
  },
  {
    id: 210908,
    title: 'Seu anúncio não está ruim. Sua oferta está.',
    audience: 'Sellers com anúncio sem performance. Ângulo: avaliar preço, prazo, reputação, Full, concorrência e promoção.',
    format: 'Reel',
    priority: 'Média',
  },
  {
    id: 210909,
    title: 'Quando vale a pena começar a importar?',
    audience: 'Sellers pensando em importação. Ângulo: responder uma pergunta real de participante com critérios práticos.',
    format: 'Reel',
    priority: 'Média',
  },
];
